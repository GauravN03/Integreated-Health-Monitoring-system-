...
def bmi():
	...
	global bmi1
	bmi1 = readFirebase()
	return render_template('bmi.html',name=name,bmi=bmi1)
...
def video_stream():
	...
	global bmi1
	global detect_name
	return Response(detectFood(bmi1,detect_name),mimetype='multipart/x-mixed-replace; boundary=frame')

@app.route('/video1', methods=['GET', 'POST'])
def video1():
	global name
	return render_template('video1.html',name=name)
